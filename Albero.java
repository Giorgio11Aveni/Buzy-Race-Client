 ...
 * @author aveni
 */
public class Albero extends Oggetto implements Runnable {
    ...
    public Albero(BufferedImage cespuglio, Livello1 game, int x) {
    ...
    void disegna(Graphics g) {
        ...
        g.drawImage(cespuglio, x, y, larghezza, altezza, game);
    }
