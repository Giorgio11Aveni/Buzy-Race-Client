...
public class Livello3 extends Canvas implements Runnable, KeyListener, InterfacciaLivello{
    ...
    BufferedImage elicottero = null;
    BufferedImage img_giocatore = null;
    BufferedImage aereoplano = null;
    BufferedImage nuvola = null;
    BufferedImage uccello = null;
    BufferedImage aereo = null;
    public boolean attivo = false;
    private Giocatore giocatore;
    private OstacoliLivello3 ostacoli;
    private Nuvole nuvole1;
    ...
    public void IniziaGioco(){
        ...
        ostacoli = new OstacoliLivello3(elicottero, aereoplano, uccello, aereo, this);
        Thread ostacolilivello1 = new Thread (ostacoli);
        ostacolilivello1.start();
        nuvole1= new Nuvole(nuvola, this);
        Thread alberilivello1 = new Thread(nuvole1);
    ...
    public void caricaRisorse(){
        ...
        String posizione = "/Immagini/Livello3/elicottero.png";
       
        Caricatore_Immagini loader = new Caricatore_Immagini();
        sfondo = loader.CaricaImmagine("/Immagini/Livello3/sfondo.png" );
        elicottero = loader.CaricaImmagine(posizione);
        img_giocatore = loader.CaricaImmagine("/Immagini/Livello3/giocatore.png");
        nuvola = loader.CaricaImmagine("/Immagini/Livello3/nuvola.png");
        aereoplano= loader.CaricaImmagine("/Immagini/Livello3/aereoplano.png");
        uccello = loader.CaricaImmagine("/Immagini/Livello3/uccello.png");
        aereo = loader.CaricaImmagine("/Immagini/Livello3/aereo.png");
    ...
    public void aggiorna() throws IOException {
        ...
        // *** GESTIONE DELLE COLLISIONI IN BASE AL TIPO DI OGGETTO ***
                ...
                if (oggetto1 instanceof Elicottero && giocatore.healt != 10){ //ELICOTTERO E VITE > 1
                ...
                if (oggetto1 instanceof Elicottero && giocatore.healt == 1){ //ELICOTTERO E VITE = 1
                ...
                if (oggetto1 instanceof Aereoplano){ // AEREOPLANO
                ...
                if (oggetto1 instanceof Uccello){ // UCCELLO
                ...
                if (oggetto1 instanceof Aereo){ // AEREO
    ...
    public void disegna() throws IOException { //METODO CHE PERMETTE DI VISUALIZZARE TUTTI GLI OGGETTI DEL GIOCO E LO SFONDO
        ...
        g.drawString("Punteggio: " + punt + "/1500", 265, 657);
        ...
        if (!attivo && controllaSconfitta() == true){
            ...
            g.drawString("Punteggio: " + punt+ " su 1500", 555, 450);
        ...
        if (!attivo && controllaVittoria() == true){
            ...
            if (punt == 1350){
                ...
                g.setFont(new Font("Comic Sans", Font.ITALIC, 20));
                g.drawString("Bonus vite extra : 350 punti", 520,355);
                g.drawString("Punteggio: " + punt , 580, 385);
                g.setFont(new Font("Comic Sans", Font.ITALIC, 15));
                g.drawString("Premi spazio per giocare il prossimo livello", 490, 420);
                g.drawString("Premi esc per tornare al menù principale", 500, 440);
            ...
            if (punt == 1300){
                ...
                g.setFont(new Font("Comic Sans", Font.ITALIC, 20));
                g.drawString("Bonus vite extra : 300 punti", 520,355);
                g.drawString("Punteggio: " + punt , 580, 385);
                g.setFont(new Font("Comic Sans", Font.ITALIC, 15));
                g.drawString("Premi spazio per giocare il prossimo livello", 490, 420);
                g.drawString("Premi esc per tornare al menù principale", 500, 440);
    ...
    public void ricompensa(){
        ...
        if (giocatore.healt == 153){
            
            this.punt += 250;
 
        }
        
        if (giocatore.healt == 164){
            
            this.punt += 300;
 
        }
        if (giocatore.healt == 175){
